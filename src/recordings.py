...
DEFAULTS = {
    ...
    #   що триває довше.
    "thermal_mode": "normal",
    #   thermal_meeting / thermal_ft — окремі вмикачі сторожа на двох ділянках:
    #   розділення голосів після «Стоп» і черга транскрибації файлів. Поріг у
    #   них спільний (thermal_mode), а от чи стерегти — рішення різне: зустріч
    #   людина чекає зараз, а черга файлів може й потерпіти.
    "thermal_meeting": True,
    "thermal_ft": True,
}
