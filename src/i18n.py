...
_UK = {
    ...
    "editor.open": "Відкрити редактор",
    "editor.label": "Уточнити транскрипт під звук",
    "editor.help": "Відкриває останній транскрипт разом із записом: слухати, правити текст, розставляти імена. Оригінал не змінюється — правки лягають окремим файлом.",
    "editor.item": "уточнити",
    "notif.editorFailTitle": "Редактор не відкрився",
    "notif.editorNoTranscript": "Немає жодного транскрипту з мітками часу",
    "notif.editorNoSpans": "У цього транскрипту немає міток часу — його зроблено раніше",
...
_EN = {
    ...
    "editor.label": "Refine the transcript against the audio",
    "editor.help": "Opens the latest transcript together with its recording: listen, fix the text, name the speakers. The original is never changed — edits go to a separate file.",
    "editor.item": "refine",
    "notif.editorFailTitle": "The editor did not open",
    "notif.editorNoTranscript": "No transcript with time marks yet",
    "notif.editorNoSpans": "This transcript has no time marks — it predates the feature",
